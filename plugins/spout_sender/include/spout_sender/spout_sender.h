 ...
 */
#ifndef SPOUT_SENDER_H_INCLUDED
#define SPOUT_SENDER_H_INCLUDED
...
// from a DLL simpler. All files within this DLL are compiled with the SPOUT_SENDER_EXPORTS
// symbol defined on the command line. this symbol should not be defined on any project
// that uses this DLL. This way any other project whose source files include this file see 
// SPOUT_SENDER_API functions as being imported from a DLL, whereas this DLL sees symbols
// defined with this macro as being exported.
#ifdef SPOUT_SENDER_EXPORTS
#define SPOUT_SENDER_API __declspec(dllexport)
#else
#define SPOUT_SENDER_API __declspec(dllimport)
#endif
#else /* _WIN32 */
#define SPOUT_SENDER_API
#endif /* _WIN32 */
 ...
 * @return 200 -- (ver.: 2.00)
 */
SPOUT_SENDER_API int mmplgPluginAPIVersion(void);
 ...
 */
SPOUT_SENDER_API void mmplgReleasePluginCompatibilityInfo(
 ...
 */
SPOUT_SENDER_API void mmplgReleasePluginInstance(
