...
void view_poke_rendering(AbstractView& view, megamol::frontend_resources::GenericImage& frontend_image) {
...
bool view_rendering_execution(
    ...
    megamol::frontend_resources::GenericImage& frontend_image)
{
