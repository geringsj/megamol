...
namespace view {
    ...
    MEGAMOLCORE_API bool view_init_rendering_state(void* module_ptr, std::vector<megamol::frontend::FrontendResource> const& resources, megamol::frontend_resources::GenericImage& fronend_image, ViewportTile viewport_tile);
